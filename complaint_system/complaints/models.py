...
class Complaint(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.PROTECT, related_name='complaints', null=True, blank=True)
...
class Department(models.Model):
    """Legacy department model - keeping for existing data"""
...
class FacultyProfile(models.Model):
    """Legacy faculty profile - keeping for existing data"""
...
class StudentProfile(models.Model):
    """Legacy student profile - keeping for existing data"""
    user = models.OneToOneField(User, on_delete=models.CASCADE)
